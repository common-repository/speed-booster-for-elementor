...
namespace SpeedBoosterforElementor\Appsero; 

/**
 * SpeedBoosterforElementor\Appsero Insights
 *
...
class Insights {
	...
	public function __construct($client, $name = null, $file = null)
	{
		...
		if (is_object($client) && is_a($client, 'SpeedBoosterforElementor\Appsero\Client')) {
			$this->client = $client;
		}
	}
	...
	public function admin_notice()
	{
		...
		$notice .= 'We are using SpeedBoosterforElementor\Appsero to collect your data. <a href="' . $policy_url . '">Learn more</a> about how SpeedBoosterforElementor\Appsero collects and handle your data.</p>';
	 ...
	 */
	private function sync_fluent_contact() {
		...
		$product = new \WPPOOL\Plugin( 'elementor_speed_optimizer', $user_data );
			...
			<div class="wd-dr-modal-wrap">
				...
				<div class="wd-dr-modal-body">
					...
					<p class="wd-dr-modal-reasons-bottom">
						<?php
						echo sprintf(
							$this->client->__trans('We share your data with <a href="%1$s" target="_blank">SpeedBoosterforElementor\Appsero</a> to troubleshoot problems &amp; make product improvements. <a href="%2$s" target="_blank">Learn more</a> about how SpeedBoosterforElementor\Appsero handles your data.'),
