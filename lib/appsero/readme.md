...
The `StockSyncWithGoogleSheetForWooCommerce\Appsero\Client` class has *three* parameters:

```php
$client = new StockSyncWithGoogleSheetForWooCommerce\Appsero\Client( $hash, $name, $file );
```
...
You can obtain the **hash** for your plugin for the [StockSyncWithGoogleSheetForWooCommerce\Appsero Dashboard](https://dashboard.appsero.com). The 3rd parameter **must** have to be the main file of the plugin.
...
function appsero_init_tracker_appsero_test() {
    ...
    $client = new StockSyncWithGoogleSheetForWooCommerce\Appsero\Client( 'a4a8da5b-b419-4656-98e9-4a42e9044891', 'Akismet', __FILE__ );
...
```php
$client = new StockSyncWithGoogleSheetForWooCommerce\Appsero\Client( 'a4a8da5b-b419-4656-98e9-4a42e9044892', 'Twenty Twelve', __FILE__ );
```
...
You can add extra metadata from your theme or plugin. In that case, the **keys** has to be whitelisted from the StockSyncWithGoogleSheetForWooCommerce\Appsero dashboard.
...
First set your deactivation reasons in StockSyncWithGoogleSheetForWooCommerce\Appsero dashboard then map them in your plugin/theme using filter hook.
...
Created and maintained by [StockSyncWithGoogleSheetForWooCommerce\Appsero](https://appsero.com).
